...
;;; don't use o, because it's the namespace of org
  ...
  ",A" 'diff-region-tag-selected-as-a ",B" 'diff-region-compare-with-b
  ",b" 'helm-mini ",c" 'avy-goto-word-1 ",w"
  'avy-goto-char-2 ",g" 'google-translate-at-point
...
(define-key evil-insert-state-map (kbd "M-i") 'pyim-convert-pinyin-at-point)
